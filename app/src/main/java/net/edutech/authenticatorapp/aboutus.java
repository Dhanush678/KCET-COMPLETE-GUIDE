...
import net.edutech.authenticatorapp.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btTEXT.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String sub = "Prepare for K-CET with kcet Complete Guide which is a package of study materials, video lectures, colleges list , Mock tests. Predict your rank, free college predictor etc...  In one place It's ad free, download the app now";
